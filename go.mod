...
require (
	...
	github.com/lightninglabs/lndclient v0.14.0-3 // indirect
...
replace github.com/lightninglabs/pool => github.com/orbitalturtle/pool v0.4.4-alpha.0.20211105014447-74b33e28a63d
