...
replace github.com/lightninglabs/pool => github.com/voltagecloud/pool v0.5.1-alpha.0.20220309190137-d96268cf5aba

// v0.4.4-alpha.0.20211212225543-1992699af5b5
