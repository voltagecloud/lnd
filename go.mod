...
require (
	...
	github.com/lightninglabs/pool/auctioneerrpc v1.0.5 // indirect
...
replace github.com/lightninglabs/pool => github.com/orbitalturtle/pool v0.4.4-alpha.0.20220606174835-cba480feed92
