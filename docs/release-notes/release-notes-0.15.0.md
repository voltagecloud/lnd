...
* A new command `lncli leaseoutput` was [added](https://github.com/voltagecloud/lnd/pull/5964).
...
* Add an [always on](https://github.com/voltagecloud/lnd/pull/6232) mode to
