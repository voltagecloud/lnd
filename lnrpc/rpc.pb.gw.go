...
var (
	...
	pattern_Lightning_RegisterSidecar_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "sidecar", "register"}, "", runtime.AssumeColonVerbOpt(true)))
)
