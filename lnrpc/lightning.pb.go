...
var file_lightning_proto_rawDesc = []byte{
	...
	,
	...
	0x32, 0x91, 0x26, 0x0a, 0x09, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x69, 0x6e, 0x67, 0x12, 0x4a,
	...
	0x74, 0x6f, 0x6d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x30, 0x01, 0x12, 0x46, 0x0a, 0x0f,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x12,
	0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14,
	0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x54, 0x69,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*SidecarTicket)(nil),                                       // 204: lnrpc.SidecarTicket
	(*RegisterSidecarRequest)(nil),                              // 205: lnrpc.RegisterSidecarRequest
...
var file_lightning_proto_depIdxs = []int32{
	...
	223, // 107: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	224, // 108: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	6,   // 109: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	225, // 110: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	226, // 122: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	227, // 138: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	211, // 152: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	211, // 153: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	214, // 154: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	211, // 155: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	211, // 156: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	205, // 232: lnrpc.Lightning.RegisterSidecar:input_type -> lnrpc.RegisterSidecarRequest
	103, // 233: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	106, // 234: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	26,  // 235: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	37,  // 236: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	41,  // 237: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	43,  // 238: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	24,  // 239: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	39,  // 240: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	45,  // 241: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	47,  // 242: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	49,  // 243: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	51,  // 244: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	53,  // 245: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	66,  // 246: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	68,  // 247: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	70,  // 248: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	72,  // 249: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	98,  // 250: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	58,  // 251: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	100, // 252: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	62,  // 253: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	33,  // 254: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	85,  // 255: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	83,  // 256: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	95,  // 257: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	31,  // 258: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	78,  // 259: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	157, // 260: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	29,  // 261: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	29,  // 262: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	29,  // 263: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	29,  // 264: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	143, // 265: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	146, // 266: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	140, // 267: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	140, // 268: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	161, // 269: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	151, // 270: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	154, // 271: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	155, // 272: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	122, // 273: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	124, // 274: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	120, // 275: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	116, // 276: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	110, // 277: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	128, // 278: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	130, // 279: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	132, // 280: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	159, // 281: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	165, // 282: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	168, // 283: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	171, // 284: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	173, // 285: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	176, // 286: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	181, // 287: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	179, // 288: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	176, // 289: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	184, // 290: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	186, // 291: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	188, // 292: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	191, // 293: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	197, // 294: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	198, // 295: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	204, // 298: lnrpc.Lightning.RegisterSidecar:output_type -> lnrpc.SidecarTicket
	233, // [233:299] is the sub-list for method output_type
	167, // [167:233] is the sub-list for method input_type
