...
var file_lightning_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x7a, 0x65, 0x64, 0x22, 0x27, 0x0a, 0x0d, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72,
	0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x57,
	0x0a, 0x16, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x69, 0x63, 0x6b,
	...
	0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x61, 0x75, 0x74, 0x6f, 0x4e, 0x65,
	0x67, 0x6f, 0x74, 0x69, 0x61, 0x74, 0x65, 0x2a, 0xcb, 0x02, 0x0a, 0x10, 0x4f, 0x75, 0x74, 0x70,
	...
	0x50, 0x41, 0x52, 0x41, 0x4d, 0x45, 0x54, 0x45, 0x52, 0x10, 0x04, 0x32, 0xd7, 0x26, 0x0a, 0x09,
	...
	0x69, 0x61, 0x73, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a,
	0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72,
	0x12, 0x1d, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x14, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x54,
	0x69, 0x63, 0x6b, 0x65, 0x74, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_lightning_proto_msgTypes = make([]protoimpl.MessageInfo, 214)
var file_lightning_proto_goTypes = []interface{}{
	...
	(*SidecarTicket)(nil),                                       // 210: lnrpc.SidecarTicket
	(*RegisterSidecarRequest)(nil),                              // 211: lnrpc.RegisterSidecarRequest
	...
	nil, // 227: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	nil, // 228: lnrpc.NodeUpdate.FeaturesEntry
	nil, // 229: lnrpc.Invoice.FeaturesEntry
	nil, // 230: lnrpc.Invoice.AmpInvoiceStateEntry
	nil, // 231: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 232: lnrpc.PayReq.FeaturesEntry
	nil, // 233: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
}
var file_lightning_proto_depIdxs = []int32{
	...
	227, // 97: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	228, // 102: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	229, // 111: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	230, // 112: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 113: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	231, // 114: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	232, // 126: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	233, // 142: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	217, // 156: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	217, // 157: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	220, // 158: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	217, // 159: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	217, // 160: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	...
	211, // 237: lnrpc.Lightning.RegisterSidecar:input_type -> lnrpc.RegisterSidecarRequest
	109, // 238: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	112, // 239: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	28,  // 240: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	40,  // 241: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	44,  // 242: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	46,  // 243: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	26,  // 244: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	42,  // 245: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	48,  // 246: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	50,  // 247: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	52,  // 248: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	54,  // 249: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	56,  // 250: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	72,  // 251: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	74,  // 252: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	76,  // 253: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	78,  // 254: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	104, // 255: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	61,  // 256: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	106, // 257: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	68,  // 258: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	35,  // 259: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	91,  // 260: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	89,  // 261: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	101, // 262: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	33,  // 263: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	84,  // 264: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	163, // 265: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	31,  // 266: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	31,  // 267: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	31,  // 268: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	31,  // 269: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	149, // 270: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	152, // 271: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	146, // 272: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	146, // 273: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	167, // 274: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	157, // 275: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	160, // 276: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	161, // 277: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	128, // 278: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	130, // 279: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	126, // 280: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	122, // 281: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	116, // 282: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	134, // 283: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	136, // 284: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	138, // 285: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	165, // 286: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	171, // 287: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	174, // 288: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	177, // 289: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	179, // 290: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	182, // 291: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	187, // 292: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	185, // 293: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	182, // 294: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	190, // 295: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	192, // 296: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	194, // 297: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	197, // 298: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	203, // 299: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	204, // 300: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	...
	64,  // 303: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	210, // 304: lnrpc.Lightning.RegisterSidecar:output_type -> lnrpc.SidecarTicket
