...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/voltagecloud/lnd/chainntnfs)
...
```shell
$  go get -u github.com/voltagecloud/lnd/chainntnfs
```
